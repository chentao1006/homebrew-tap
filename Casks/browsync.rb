cask "browsync" do
  version "1.1.13"
  sha256 "780715334236020958bec99b63df5e3b4e3b9d0b9bbbd69ca1ea045a43639eea"

  url "https://github.com/chentao1006/browsync/releases/download/v1.1.13/BrowSync.dmg"
  name "BrowSync"
